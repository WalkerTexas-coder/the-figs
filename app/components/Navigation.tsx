    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">The Figs</span>
            <Image
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-700 hover:text-figs-pink transition-colors"
            aria-label="Spotify"
          >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden" role="dialog" aria-modal="true">
          <div className="fixed inset-0 z-10 bg-black/30" onClick={() => setMobileMenuOpen(false)} />
          <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-figs-cream px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
